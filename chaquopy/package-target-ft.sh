...
version_short=$version_major.$version_minor"t"
...
for prefix in $prefixes; do
    abi=$(basename $prefix)
    echo "$abi"
# Chaquopy sibling helper - point CHAQUOPY_ROOT at a patched checkout
CHAQUOPY_ROOT=${CHAQUOPY_ROOT:-$FT_ROOT/chaquopy}
    . ""$CHAQUOPY_ROOT/target/abi-to-host.sh""
    . ""$CHAQUOPY_ROOT/target/android-env.sh""  # For CC and STRIP
